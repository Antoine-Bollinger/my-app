...
export default function Modal({ body = '', header = '', className = '' }) {
    ...
    const closeModal = useCallback((goLink = false) => {
        const url = document.querySelector('.modal-link').dataset.href;
            ...
            <div tabIndex="-1" className="overflow-y-auto overflow-x-hidden absolute inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" onClick={() => closeModal()}>
                        ...
                        <div className="p-6 text-center">
                            ...
                            <div className="flex justify-around gap-8">
                                ...
                                <button data-href="" className="modal-link w-full text-center text-white bg-orange-900 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5" onClick={() => closeModal(true)}>
